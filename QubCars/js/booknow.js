...
function initMap(position){
    ...
    let url_str = 'https://maps.googleapis.com/maps/api/geocode/json?latlng='+lati+','+lngi+'&key=AIzaSyC1WUe2T0ZEi5RzsA0lzuU996Qb7NtNprE'
    ...
    google.maps.event.addListener(marker, 'dragend', function(evt){
    	...
    	let url_str = 'https://maps.googleapis.com/maps/api/geocode/json?latlng='+evt.latLng.lat().toFixed(3)+','+evt.latLng.lng().toFixed(3)+'&key=AIzaSyC1WUe2T0ZEi5RzsA0lzuU996Qb7NtNprE'
    	$.getJSON(url_str, function(data) {
        	console.log(data);
